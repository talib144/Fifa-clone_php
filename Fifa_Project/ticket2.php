...
<head>
    ...
    <title>Fifa.com Club Sign-up</title>
    <link rel="stylesheet" href="Resources\css\ticket2-style.css">
</head>
<body>
    <div id="bgImage">
    ...
    <div id="uiContainer">
        ...
        <hr>
        <span id="start_Span">Let's get you started!</span>
        ...
        <form method="post">
            ...
            <label for="country">Where do you live</label><br>        
            ...
            <select id="lang" name="language" class="form-control">                
                ...
                <option value="Duetch">Duetch</option>                
            </select>
